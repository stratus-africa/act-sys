  ...
  return (
    <section className="border border-border bg-card">
      <div className="px-6 py-4 border-b border-border flex justify-between items-center">
        ...
        <Link to="/applicants" className="text-[10px] font-mono uppercase tracking-widest text-primary hover:underline inline-flex items-center gap-1">All <ArrowRight className="size-3" /></Link>
      </div>
      ...
      <div className="px-6 py-5 space-y-2.5">
        {HR_STAGES.map((s) => {
          ...
          const pct = (n / max) * 100;
          return (
            <Link key={s} to="/applicants" className="grid grid-cols-[110px_1fr_40px] items-center gap-3 group">
              <span className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground group-hover:text-foreground">{s}</span>
